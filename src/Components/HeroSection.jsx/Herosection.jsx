  ...
  return (
    <div className="relative flex justify-center items-center bg-gradient-to-r from-indigo-500 to-purple-600">
      ...
      <div className="flex min-w-full h-screen">
        <div className="bg-green-600 w-2/5 p-20 flex flex-col justify-start shadow-lg">
        ...
        <div className="bg-black text-white w-3/5 p-16 pl-20 flex flex-col justify-start shadow-lg">
          ...
          <p className="text-lg mt-4 mt-36 leading-relaxed pl-20">
          ...
          <div className=' flex justify-center items-center my-28 gap-10'>
          <button className='px-5 py-3 bg-yellow-400 rounded-xl'>Download CV</button>
          <button className='px-5 py-3 bg-red-500 rounded-xl'>Contact Me</button>
        </div>
        </div>
