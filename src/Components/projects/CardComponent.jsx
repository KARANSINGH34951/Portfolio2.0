  ...
  return (
    <div className="bg-white border rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="p-4">
        ...
        <p className="text-gray-600 text-sm mb-4">{projectDesc}</p>
        <div className="flex justify-center items-center gap-6">
          <a href={githubLink} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-500 text-2xl">
            <FaGithub />
          </a>
          <a href={liveLink} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-500 text-2xl">
            <FaExternalLinkAlt />
          </a>
        </div>
      </div>
