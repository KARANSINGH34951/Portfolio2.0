...
const Experience = () => {
  return (
    <div className="bg-gray-900 p-10 text-white">
      <h1 className="text-4xl font-semibold mb-6">My Experience</h1>
      <hr className="border-t-2 border-yellow-400 mb-6" />

      <div className="flex justify-between gap-8">
      
        <div className="w-full sm:w-1/2 lg:w-2/5 space-y-6">
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300">
            <h2 className="text-2xl font-bold text-yellow-400 mb-4">Frontend Developer</h2>
            <p>
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300">
            <h2 className="text-2xl font-bold text-yellow-400 mb-4">Backend Developer</h2>
            <p>
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300">
            <h2 className="text-2xl font-bold text-yellow-400 mb-4">Full Stack Developer</h2>
            <p>
        ...
        <div className="w-full sm:w-1/2 lg:w-3/5 flex justify-center items-center">
          <img
